...
export default function MailingList() {
  return (
    <div>
      <title>Some</title>
      <p
        className='pl-1000 text-6xl mr-1000 whitespace-nowrap font-bold dark:text-white'
        style={{ paddingLeft: '100px', paddingTop: '10px', }}
      >Join Our Mailing List!</p>
      <div className="h-screen flex">

        <div className="mt-2 flex   w-1/2 justify-center items-center bg-white" style={{ height: "500px", }}>
          <img className="pb-21" src={text} alt="streamline with us"></img>
        </div>
        <div className="flex w-1/2 justify-center items-center bg-white" style={{ height: "500px", }}>
