...
<div class="mt-2 flex w-1/2 justify-center items-center bg-white">
  ...
  <form class="bg-white">
      ...
      <div>
      <Link to="/main">
      <button type="submit" class="block w-full bg-blue-700 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Sign up</button></Link>
      <span class="pl-12 text-sm ml-0 hover:text-blue-500 cursor-pointer">Already have an account? Log in</span>
      </div>
    </form>
